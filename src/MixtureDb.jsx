...
import {
  ...
  faCheckCircle,
  faChartBar,
  faRightLeft // Import faRightLeft for Transfer Tasks
...
const MixtureDb = () => {
  ...
  return (
    <div
      ...
      className={isSidebarOpen && window.innerWidth < 768 ? 'sidebar-open-mobile' : ''}
    >
      {/* Sidebar */}
      <aside
        style={{
      ...
      >
        <div style={baseStyles.sidebarHeader} className="sidebar-header">
          <img src={userProfilePlaceholder} alt="User Profile" style={baseStyles.sidebarProfileImage} />
...
/>
          ...
          {navItems.map((item) => (
            <div
              ...
              style={{
                ...
                ...(activeNavItem === item.name ? baseStyles.sidebarNavItemHover : {}),
              }}
              onMouseEnter={(e) => {
                if (activeNavItem !== item.name) {
                  e.currentTarget.style.backgroundColor = baseStyles.sidebarNavItemHover.backgroundColor;
                  e.currentTarget.style.transform = baseStyles.sidebarNavItemHover.transform;
                }
              }}
              onMouseLeave={(e) => {
                if (activeNavItem !== item.name) {
                  e.currentTarget.style.backgroundColor = baseStyles.sidebarNavItem.backgroundColor;
        ...
        <button
          ...
          onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = baseStyles.logoutButtonHover.backgroundColor)}
          onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = baseStyles.logoutButton.backgroundColor)}
      ...
      >
        ...
        <header style={baseStyles.header}>
          <div style={baseStyles.headerLeft}>
            ...
            <h1 style={baseStyles.desktopHeaderTitle} className="desktop-header-title">Dashboard</h1>
          </div>
        ...
        <div style={baseStyles.cardsGrid} >
          ...
          >
            <FontAwesomeIcon icon={faClipboardList} style={{ ...baseStyles.cardIcon, color: '#7853C2' }} />
          ...
          >
            <FontAwesomeIcon icon={faHourglassHalf} style={{ ...baseStyles.cardIcon, color: '#FFC107' }} />
          ...
          >
            <FontAwesomeIcon icon={faRightLeft} style={{ ...baseStyles.cardIcon, color: '#17A2B8' }} /> {/* Using a suitable color for new card */}
